...
namespace C4I.Applications.SCE.Interfaces
{
    ...
    public class BoundingBox : IEquatable<BoundingBox>
    {
        ...
        {
            _Min = new Point(minX, minY, 0);
            _Max = new Point(maxX, maxY, 0);
            CheckMinMax();
        }
        ...
        {
            get { return new Point(Left, Top, 0); }
        }

        public Point TopRight
        {
            get { return new Point(Right, Top, 0); }
        }

        public Point BottomLeft
        {
            get { return new Point(Left, Bottom, 0); }
        }

        public Point BottomRight
        {
            get { return new Point(Right, Bottom, 0); }
        }
